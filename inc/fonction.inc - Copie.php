...
function ajouterProduitDansPanier($titre, $id_produit, $quantite, $prix, $taille) { // réception des arguments en provenance de panier.php
  ...
  if ($position_produit !== false) {
    ...
    $_SESSION['panier']['taille'][$position_produit] .= $taille; 
